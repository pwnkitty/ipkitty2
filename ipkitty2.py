...
def change():
    ...
    print ('[+] Your Current IP Is : '+str(ma_ip()))
...
░▒▓█▓▒░       ░▒▓█████████████▓▒░░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░  ░▒▓█▓▒░      ░▒▓█▓▒░      ░▒▓█▓▒░     
''')
print("\033[1;40;31m Follow On Instagram @pwnkitty <3\n")
...
os.system("service tor start")
x = input("[+] interval to change Ip in Sec [type=60] >> ")
lin = input("[+] how many time do you want to change your ip? >>")
if int(lin) ==int(0):
